...
(1, 'gktech', 'gk.techs2@gmail.com', 'gktech_password2023', '2023-08-04 20:31:45', '2023-08-17');
(2, 'olacodes', 'olateju202@gmail.com', 'Olamide2004#', '2023-08-04 20:31:45', '2023-08-17');
-- --------------------------------------------------------
...
INSERT INTO `brand` (`id`, `brand_name`, `description`, `stock`, `posting_date`) VALUES
(1, 'Oraimo', '20KMah Oraimo Power Bank', 'In stock', '2016-08-11 04:31:42'),

-- --------------------------------------------------------
-- TBALE STRUCTURE OF RMESSAGES AND THE MESSAGE PART OF THE PHP CODE  IN THE DATABASE AND ALL OF IT ON THE CODEAND THE WORKING PARTS IN THE PHP SCRIPST ARE HERE

CREATE TABLE `message` (
  `id` int(11) NOT NULL,
  `regNo` longtext DEFAULT NULL,
